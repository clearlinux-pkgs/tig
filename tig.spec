...
Source0  : https://github.com/jonas/tig/releases/download/tig-2.5.9/tig-2.5.9.tar.gz
...
%prep
%setup -q -n tig-2.5.9
cd %{_builddir}/tig-2.5.9
pushd ..
cp -a tig-2.5.9 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711844506
